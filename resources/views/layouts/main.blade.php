...
<body>
    <header class="oleez-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="{{route('post.index')}}"><img src="{{asset('assets/images/Logo_2.svg')}}" alt="Oleez"></a>
                ...
                <div class="collapse navbar-collapse" id="oleezMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle disabled" href="#!" id="pagesDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle disabled" href="#!" id="portfolioDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Portfolio</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle disabled" href="#!" id="blogDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog</a>
                    ...
                    <ul class="navbar-nav d-none d-lg-flex">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle disabled" href="#!" id="languageDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ENG</a>
                            <!-- <div class="dropdown-menu" aria-labelledby="languageDropdown" style="display: none;">
                            <a class="dropdown-item" href="#!">ARB</a>
                            <a class="dropdown-item" href="#!">FRE</a>
                        </div> -->
                        </li>
    ...
    <style>
        .like-button__outline-none:focus {
            outline: none;
        }
    </style>
    @yield('content')
